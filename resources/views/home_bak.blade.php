...
<div class="hero-wrap d-flex align-items-center justify-content-center text-center" 
  ...
  <div class="container position-relative z-2" style="z-index: 2;">
    <div class="row justify-content-center">
      <div class="col-md-8 text-white animate__animated animate__fadeInUp">
        <h1 class="display-4 fw-bold mb-3" 
            style="font-family: 'Edu NSW ACT Hand', cursive; color: #f5e6e6;">
          Be at Peace<span style="color:#ffbcbc;">.com</span>
        </h1>
        ...
        <p class="lead mb-5" style="font-family: 'Edu NSW ACT Hand', cursive; color: #fff9f9;">
          To be a globally trusted online counseling center, empowering individuals to find peace of
...
<section class="ftco-section">
  ...
  <p>
    In today’s fast-paced world, stress has become a common part of life. Our <strong>Stress Management &amp; Resilience Coaching</strong> helps individuals identify sources of stress, develop healthy coping mechanisms, and build emotional resilience to face challenges with confidence and calm.
  </p>
...
@include('happyClient')
<section class="ftco-appointment ftco-section img" style="background-image: url(images/happy_client_6.png);">
